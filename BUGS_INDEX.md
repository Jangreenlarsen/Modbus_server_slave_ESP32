...
| FEAT-110 | SSE server mættet alarm | ✅ DONE | 🟠 MEDIUM | v7.8.4.2 | Alarm (severity ADV) når SSE server når max klienter: "SSE server mættet 3/3 klienter". Auto-clear når en plads frigives. Integreret i `alarm_check_thresholds()` periodisk check (api_handlers.cpp) |
