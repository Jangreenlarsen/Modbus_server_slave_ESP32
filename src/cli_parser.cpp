...
void cli_parser_print_help(void) {
  ...
  debug_println("                      output-coil:<addr>");
  debug_println("      Mode 1: One-shot (3-phase sequence)");
  debug_println("");
  ...
  debug_println("                      p1-output:<level> p2-output:<level> \\");
  debug_println("                      output-coil:<addr> enabled:<0|1>");
  ...
  debug_println("                      delay-ms:<ms> output-coil:<addr>");
  ...
  debug_println("");
  debug_println("  Virtual GPIO example (for testing without hardware):");
  debug_println("    set gpio 120 static map input:0  - Virtual GPIO 120 reads COIL 20");
  debug_println("    Virtual GPIO 100+n reads COIL n");
  debug_println("");
